...
<body data-spy="scroll" data-target=".navbar" data-offset="50" onload="myFunction()"> 
    ...
    <div>  
       <div class="jumbotron">
          <h2 class="animated bounce">Senthur Vehicle Management</h2>      
    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:10px text-align: center; position: absolute;top: 60%;left: 50%;transform: translate(-50%, -50%);color: white;">
           
            <h1 class="animated rubberBand" > <font face ="Helvetica Neue"> Senthur Vehicle Management System </font> </h1>
            <p><font size = "4"> A management system where you can easily manage vehicles </font> </p>
    ...
    <div>
       <br><br>
        <div id="bus_route" class="container">
          ...
          <div class="row">
              <div class="col-md-6 foo">
                <p><b>The Senthur Company vechicles goes around the Sathyamangalam city in different interval.</b></p>
        ...
        <div id="driver" class="container">
          ...
          <div class="row">
              <div class="col-md-12">
                  <p style="font-size: 20px;">Trained and Punctual drivers are here, we only offer a experienced driver for the customer safety and hence it is mandatory.</p>
        ...
        <div id="bus" class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-6 foo1">
                  <p style="font-size:20px;"><b>We offer a tourist bus that could travel upto 12000 Km of distance for our hearty customers</b></p>
              </div>
        ...
        <footer style="background-color: #2f2f2f;
          ...
          padding-bottom: 70px;" class="container-fluid text-center">
                <p>For contact, call Toll free number: +916383930329</p> 
        </footer>
